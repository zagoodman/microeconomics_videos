...
\begin{abstract}
  % TODO: make abstract less specific to IMVH
	...
	In a field experiment involving over 400 lower-performing students, we randomly assigned a grade-based incentive that induced treatment students to watch over 60\% more videos than did control students.
...
%[Zack--In Table 5, why is the coefficient from col 1 so different from col 3?  Since this is an RCT, controling for demogs should improve precision but not change the point estimate.  Sample sizes differ across these columns, which could explain this, and so we need to re-estimate col 1 with the smaller col 3 sample.  Then we need to think about how to present our results.]
...
We find no evidence that treatment affects several observed study behaviors, and we proceed under the assumption that unobserved study inputs are similarly unaffected.
...
% A key question is to what extent our LATE estimates provide a parameter ion the educational production function. 
