...
The IMVH was designed to \textit{supplement} lecture as an audiovisual version of a conventional course textbook\footnote{The IMVH has also been used to ``flip'' classes; students watch IMVH videos before class and the instructor uses class time to answer questions and solve problems.}.
...
However, we find no evidence that treatment affects several observed study behaviors, and we proceed to estimate LATEs under the assumption that unobserved study inputs are similarly unaffected by treatment.
...
A similarly massive behavioral change was also found by \textcite{afg2025} who used a 8\% grade-weight incentive to encourage taking out-of-class quizzes.
In contrast, behavioral nudges such as coaching, having students set goals, and reminders have been found to be less effective at changing college student study behavior (see \textcite{oppp2019}, \textcite{plg2020}, \textcite{pw2024}) although there is some evidence that if the information is course-specific, these interventions may be more effective (see \textcite{ck2023} and \textcite{rc2023}).
...
Second, our approach to modifying grade weights is novel because we incentivize video watching by reducing the weight of a course component that had already been completed at the time of treatment (the first midterm).
This design \textit{may} allow us to estimate local average treatment effects (LATEs), the effect of watching videos on exam performance for students induced by treatment to watch videos, since watching videos is the only forward-looking incentive directly affected by treatment.
However, the validity of our LATE estimates depends on the exclusion restriction, which would be violated if the treatment-induced change in video watching also altered student studying in other courses taken at the same time as the experimental course or use of other study methods that affect exam performance.
Although we did not find significant effects of treatment on either other courses or on the study methods we observe, our data do not include all study behaviors that may affect exam scores.
Thus, we report LATE estimates under the assumption that unobserved study methods are similarly unaffected by treatment.
...
Our results are consistent with habit formation or learning an effective study strategy.
...
Fixed effects are unlikely to uncover the causal effect of a study method given substantial evidence that students change their study strategies after an exam shock, see \textcite{oettinger2002}, \textcite{ko2005}, \textcite{ss2008}, \textcite{bo2012} and \textcite{bo2015}.}
...
% Another tact we could take is to argue is the incentive aspect--a small grade incentive worked rmarkable well to encourage increased effort among at-risk students.
...
The primary benefits of lecture over the IMVH are that students can receive immediate help when they have questions, student questions may have import externalities for the learning of other students and there is a social aspect as students can interact with each other before, during, and after lecture.
...
However, our evidence suggests that \textit{Incentive} students increased their study time in Micro A by watching videos, with this additional time coming at the expense of non-academic activities such as leisure time or time in the labor market.
...
% Ignoring selection into taking Micro B and therefore estimate the effect of treatment on video watching and exam scores only on the sample of students who take Micro B.) versus assigning zero values for videos watched and exam scores for students who do not take Micro B and estimating the effect of treatment for the full sample.
...
\textcite{afg2025} conduct a within-class RCT and one of the classes was Fall Micro A in the year prior to our experiment.
...
They similarly find a huge behavioral response with treated students doing 58.7\% more quizzes than the control group (about 1.76 hours) and that treatment students do 0.14 standard deviations better on the final exam though this results was only marginally significant (the standard error was 0.09).  
