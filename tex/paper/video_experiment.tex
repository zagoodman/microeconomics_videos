...
Section \ref{studydesign} describes the study design.
Section \ref{results} presents the results of the experiment, and Section \ref{models} presents competing models of studying behavior that may explain the observed phenomena.
...
Indeed, Figure~\ref{combo_cdf} shows that the two CDFs do not cross.} are reasonable assumptions, we have concerns about both the exclusion restriction and non-interference.
...
In Table~\ref{spillover_studying}, we show that treatment did not significantly affect any observed study activity (class attendance, tutoring lab attendance, and use of the class discussion board).
...
We show attrition at each stage of the experiment in Figure~\ref{attritchart}.
...
As can be seen in Appendix Tables~\ref{balance_table_takers} and~\ref{balance_table_matched}, we find no statistically significant difference between the \textit{Control} and \textit{Incentive} arms in observable covariates including first midterm score, year, previous term's cumulative GPA, videos watched before the first midterm, ethnicity, gender, and transfer status.
...
As can be seen in Appendix Table~\ref{tab:arci_table}, we find that the weak-instrument-robust confidence intervals are very similar to those presented in Table~\ref{secondstage_table}.
...
We find no effects statistically distinguishable from zero, except, as mentioned in section \ref{attrition}, treatment students were directionally less likely to take Micro B than were control students.
