...
We find that being assigned treatment (ITT) increased midterm and final exam scores by 0.18 and 0.17 standard deviations, respectively, and that the marginal hour of video watched increased exam scores (LATE) by 0.08 standard deviations. Although the confidence intervals are, admittedly, wide, the point estimates are statistically and economically significant: a student could increase their course letter grade by one step (e.g. from a B+ to A-) by watching XX hours of videos. Our estimates suggest that XX\% of students in the control group who failed the course would have earned passing grades had they watched as many videos as their treated counterparts.
...
We conducted the field experiment during an intermediate microeconomics course over two quarters, fall 2018 and 2019, taught at a large, highly selective public research university. At this institution, intermediate microeconomics is a three-term sequence required for all students majoring in Economics, joint Economics-Mathematics, and Management Science. The experiment was conducted in the first course of the sequence, though we can observe grades in the second course of the sequence.
