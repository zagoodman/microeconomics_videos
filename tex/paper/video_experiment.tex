...
\date{This version: February 2020} % TODO: add link to most recent version
...
\begin{tikzpicture}[
  node distance=0mm,
  every node/.style = {shape=rectangle, draw=none,
                   text width = 30mm, minimum height = 1em, align=center},
  pval/.style = {shape=rectangle, draw=none,
                  inner sep=0mm, outer sep=0mm, minimum height=1em,
                  align=left},
...
% TODO - add to this section, perhaps after estimating GRF
...
Though our focus on students performing poorly on the first midterm is the same as \textcite{dgm2010} and universities often have policies focussed on poorly performing students such as the policy studied in \textcite{kow2020} and academic probation policies, some researchers may ponder why we elected to include only the bottom half of the first midterm distribution in the experiment rather than the entire class. While including the entire class would have increased statistical power, we believe the additional precision might have come at the expense of welfare losses by high performing students. The first midterm provides a signal of which students likely know for themselves how to study, both methods and duration. Coercing these high-type students to spend time with a potentially different studying method is less likely to be helpful and runs a higher risk of harming utility. On the other hand, students who, through a low midterm score, make manifest a need for alternative studying practices stand to benefit the most from instructor-provided guidance.

The positive exam effects we estimate are attributable to both watching IMVH videos and increasing the time spent self-studying for the course. Our experimental design does not allow us to separately identify the effects of these two mechanisms for improving exam performance.  Would a similar incentive structure but inducing students to read the textbook (which e-books now makes as verifiable as "watching" videos), do more online quizzes, hand in problem sets for a grade, etc. have worked as well as inducing the students to watch the IMVH?  We view this as an important area for future research.  For students, it will also be important to consider additional costs, as inducements such as reading the textbook or doing online problems from the textbook mean students must purchase the textbook to get the grade inducement and may disadvantage students from low-resourced families.  For faculty and universities, it will also be important to  consider any added costs to the instructional team as grading additional problem sets clearly has a cost and even creating more online quizzes adds to the instructional burden.  Since the IMVH has been provided free to students since it was developed in 2015 and there is no marginal cost to the instructional team of another watched video, we did not have to address either the student or instructional time costs in this experiment.
...
\customlinespace \indentrow{Unique videos} & 22.7 & 9.12 & 9.34 \\
& & (3.35)\sym{***} & (3.42)\sym{***} \\
...
\customlinespace \indentrow{Unique videos} & 32.0 & 24.16 & 24.95 \\
& & (2.39)\sym{***} & (2.48)\sym{***} \\
