...
In this study we examine an educational innovation, a video handbook, where a series of 220 (mostly) short instructional videos were organized into a book.  In the context of an educational innovation, neither instructor nor students know the return to study time using the innovation and so do not know how it compares to other study methods.    

% Other evidence of learning?  Students frequently start but drop out of college, start but drop out of classes, and change majors  
...
There is not a sharp prediction on exam performance in the second class because it depends upon both the effectiveness of video watching and ths substitutability of video watching with other educational inpits.  While point estimates are positive, standard errors are large and we do not find significantly higher grades on midterm 1 (which covers material most related to the first class) or final exam scores in the second class.     

Collectively, we interpret our findings as strong evidence that requiring studying tools known by the instructor to be effective is utility enhancing for students who manifest their limited knowledge of how best to study, perhaps through poor performance on an early stage assessment.  These results also highlight the value of identifying effective study tools

%  Another implication?  Transfer students vs studnets who started as freshman--both are adjusting to UD classes, but transfer students also adjusting to quarter system (almost all community colleges are on the semester system) and the testing at UCSD over a community college (more likely to ask transferance questions where student has to use know ledge in a new way)
...
We conducted the field experiment in four intermediate microeconomics courses, two in fall 22018 and two in fall 2019.  The university is a large, diverse and selective public research four-year university. At this institution, intermediate microeconomics is a three-term sequence required for all students majoring in Economics, joint Economics-Mathematics, and Management Science. The experiment was conducted in the first course of the sequence.  We also have grades and video viewing in the second course of the sequence.

Students were informed about the experiment during the first lecture and in the syllabus, which was provided to all students via the course webpage. At any time during the quarter, students were permitted to opt out of having their anonymized data included in the analysis, which would not begin until grades had been posted and data had been anonymized\footnote{Students could opt out via a form handled by the Teaching + Learning Commons (T+LC) so that neither the instructor nor research team could observe which students decided to opt out. The T+LC also anonymized the data for the research team before any analysis was conducted.}. Students below the age of 18 at the start of the course as well as pupils enrolled in the course via an online extension program were removed from the analysis dataset.
