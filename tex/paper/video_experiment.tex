...
\begin{figure}
	\begin{center}
		...
		\caption{\textit{Above}: $v^*(L)$ is the demand curve for video watching (in hours) as a function of leisure (in hours), $L$. Let $T$ be total study time.  At $L=1-T$, the student maximizes grades $G(v,0)$ by spending all study time watching videos, i.e. $v^*=T$. A grade incentive, $I$, for watching $v_2>T$ videos increases the demand for watching videos as shown.  \textit{Below}: Student's utility maximization problem for the neoclassical model. The student maximizes her utility over leisure $L$ and grades $G$, which are a function of time allocated to video watching $v$ and her next best studying option, $o$. The grade incentive, $I$, is given to the student conditional on watching $T$ hours of videos (inner-time budget constraint) or, in the unincentivized case, given regardless of video watching (outer time-budget constraint).}
	\end{center}
\end{figure}
...
One empirical difference across the models is whether or not there is bunching at 40 videos, the threshold to get the grade incentive.  We did not find bunching, which is predicted by both the neoclassical and behavioral models.  However, since it was not easy for students to keep track of the videos they had watched, the lack of bunching may simply reflect student uncertainty about whether they had met the 40-video threshold.  More convincing is our finding that treated students continued watching videos in the absence of any grade incentive in Micro B.  This empirical finding leads us to reject both the neoclassical and behavioral models of learning in our setting.
