...
\begin{abstract}
  % TODO: make abstract less specific to IMVH
	...
	In a field experiment involving about 400 lower-performing students, we randomly assigned a grade-based incentive that induced treatment students to watch over 60\% more videos than did control students.
...
Notably, all of these students scored below the median on the first midterm exam, suggesting a need to adjust study methods and perhaps standing to gain the most from an intervention that targets studying.
We randomly assigned a grade-based incentive to half of these lower-performing students to encourage take-up of the IMVH, which was made available to all students in the class.
...
Our experiment allows identification of intent to treat (ITT) effects which answer the question, how is student exam performance affected by the grade incentive we consider?
...
Students who receive the grade-based incentive watch over 28\% more unique videos by the second midterm and 63\% more unique videos by the final exam, or about 1.1 and 3.4 hours of content, respectively, than did their control peers. %[Zack--I think we should report videos here (and not unique videos)]
...
%[Zack--why is Table 5, col 1 so different from col 3?]

We also estimate local average treatment effects (LATEs) of video watching on exam performance.
As we discuss in the paper, identification requires that the exclusion restriction hold: treatment must affect exam scores only through its effect on video-watching behavior.
...
However, the validity of our LATE estimates depends on the exclusion restriction, which would be violated if the treatment-induced change in video watching also altered student use of other study methods that affect exam performance.
Although we did not find significant effects of treatment on the study methods we observe, our data do not include all study behaviors that may affect exam scores.
...
Our primary concern regarding the exclusion restriction is whether treatment influenced students' engagement with other study methods (see both~\parencite{aws2015} and~\parencite{m2017} for a discussion of this issue).
...
\textcite{afg2025} conduct within-class RCTs involving 1,200 students in microeconomics at both the principles and intermediate level in the year prior to our experiments, at the same university, taught by the same instructor and with a similar course structure.
Their estimates differ by course and by quarter, and so we focus on intermediate microeconomics taught in the fall of 2017.
In their experiments, students were randomly given a small grade incentive to complete out-of-class work with a concomitant reduction in the weight on two midterms and use the scores on a cumulative final exam (worth 50\% of the student's grade) as the outcome measure.
